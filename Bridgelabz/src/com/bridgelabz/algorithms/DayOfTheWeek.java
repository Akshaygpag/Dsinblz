...
public class DayOfTheWeek {
	...
	try {
	    ...
	    Calendar calendar = new GregorianCalendar(Integer.parseInt(args[2]), Integer.parseInt(args[0]),
		    Integer.parseInt(args[1]));

	    if (calendar.get(Calendar.MONTH) != Integer.parseInt(args[0])) {
	    ...
	    System.out.println(Day.values()[position] + " is the day of the week");
	} catch (Exception e) {
